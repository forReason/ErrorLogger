...
public partial class Logger
{
    ...
    /// <summary>
    /// provides the format for the logging time
    /// </summary>
    ...
    public void Log(Exception ex, Severity exceptionSeverity = Severity.Critical)
    {
        ...
        {
            AppendRecordToLog(severity: exceptionSeverity, title: ex.GetType().Name, message: ex.Message,
    ...
    {
        string formattedTime = (time ?? DateTime.Now).ToString(TimeFormat);
